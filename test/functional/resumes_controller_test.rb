...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { DOB: @resume.DOB, description: @resume.description, experince: @resume.experince, name: @resume.name, qulifaction: @resume.qulifaction }
    end
  ...
  test "should update resume" do
    put :update, id: @resume, resume: { DOB: @resume.DOB, description: @resume.description, experince: @resume.experince, name: @resume.name, qulifaction: @resume.qulifaction }
    assert_redirected_to resume_path(assigns(:resume))
  end
